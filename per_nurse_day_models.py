...
def main() -> None:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("outputs/per_nurse_day_models"))
    ...
    fold_csv = args.out_dir / "cv_fold_split_summary.csv"
    metrics_csv = args.out_dir / "cv_fold_model_metrics.csv"
    nurse_summary_csv = args.out_dir / "cv_nurse_summary.csv"
    day_stats_csv = args.out_dir / "per_day_normalized_stats.csv"
