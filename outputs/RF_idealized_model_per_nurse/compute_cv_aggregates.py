...
csv_in = base / "RF_idealized_model_per_nurse_fold_metrics.csv"
csv_out = base / "RF_idealized_model_per_nurse_aggregate_summary.csv"
md_out = base / "RF_idealized_model_per_nurse_aggregate_summary.md"
